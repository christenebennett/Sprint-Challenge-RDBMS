...
`RDBMS` is a relational database management system and `SQL` or, structured query langauge, is the language we use to speak to the database.
...
We need to have a third table that includes foreign keys referencing primary keys of each table.
